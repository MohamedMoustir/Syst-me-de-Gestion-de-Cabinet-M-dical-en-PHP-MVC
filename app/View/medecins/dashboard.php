...
// var_dump($_SESSION);
echo '<pre>';
var_dump($newPatientsLast30Days);
var_dump($approvedAppointments);
var_dump($cancelledAppointments);
var_dump($getPatientsPerMedecin);
echo '</pre>';
...
<header class="bg-white shadow-md">
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-gray-500">Temps d'Attente Moyen</h3>
                    <svg class="h-4 w-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <div class="text-2xl font-bold">25 min</div>
            </div>

            <!-- Monthly Growth -->
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-sm font-medium text-gray-500">Croissance Mensuelle</h3>
                    <svg class="h-4 w-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
